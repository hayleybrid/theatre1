<section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-4 mb-12">
  ...
  <!-- component -->
<div class="text-gray-900 pt-12 pr-0 pb-14 pl-0 bg-gray-200">
    ...
    <div class="flex flex-col items-center sm:px-5 md:flex-row">
      <div class="flex flex-col items-start justify-center w-full h-full pt-6 pr-0 pb-6 pl-0 mb-6 md:mb-0 md:w-1/2">
        <div class="flex flex-col items-start justify-center h-full space-y-3 transform md:pr-10 lg:pr-16
          ...
          <a class="text-4xl text-blue-900 font-bold leading-none lg:text-5xl xl:text-6xl">Clyde Theatre</a>
          <div class="pt-2 pr-0 pb-0 pl-0">
            <p class="text-sm font-medium inline">Glasgow based theatre company</p>
            <a class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1 underline">Have a look at what's on</a>
            <p class="inline text-sm font-medium mt-0 mr-1 mb-0 ml-1">Plays</p>
            <p class="text-gray-200 text-sm font-medium inline mt-0 mr-1 mb-0 ml-1">More plays</p>
          </div>
        </div>
      </div>
      <div class="w-full md:w-1/2">
        <div class="block">
          <img src="<?= ROOT_DIR ?>assets/images/theatre_logo.png" class="object-cover rounded-lg height: 100% width 100% btn- w-full h-full"/>
        </div>
      </div>
    </div>
    <!-- annie image -->
