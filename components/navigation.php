          ...
          <div class="hidden lg:block lg:ml-2">
            <div class="flex">
              <?php if (!isset($_SESSION['loggedin'])): ?>
                <a href="<?= ROOT_DIR ?>" class="ml-2 py-2 rounded-md text-sm leading-5 font-medium transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white" style="color: #eab308">Clyde Theatre </a>
                ...
                <a href="<?= ROOT_DIR ?>register" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Register </a>
              <?php else: ?>
                ...
                <a href="<?= ROOT_DIR ?>blogs" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Blog </a>
                    <?php if ($_SESSION['is_admin'] == 1): ?>
                      <a href="<?= ROOT_DIR ?>a/pendingComments" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Pending Reviews </a>
                      <a href="<?= ROOT_DIR ?>a/allUsers" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> Users </a>
                    <?php elseif ($_SESSION['is_admin'] == 0): ?>
                      <a href="<?= ROOT_DIR ?>u/comments" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> My reviews </a>
                      <a href="<?= ROOT_DIR ?>u/account" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-white hover:bg-yellow-500 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 "> My account </a>
